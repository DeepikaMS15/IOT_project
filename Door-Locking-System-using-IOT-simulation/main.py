      ...
      if(characters[3] ==  "#"):
       if(inputstring == secretkey):
        ...
        if(inputstring!= hidekey):
          emailAlert("alert", "You need to check in who is trying to access your door", "apsingh9922@gmail.com")
        time.sleep(1)
...
def emailAlert(subject, body, to):
   ...
   msg['Subject'] = 'Alert'
   msg['From'] = "2020a1r074@mietjammu.in"
   msg['To'] = "apsingh9922@gmail.com"

# Send the message via our own SMTP server.
   server = smtplib.SMTP_SSL('smtp.gmail.com', 465)
   server.login("2020a1r074@mietjammu.in", "password")
